...
const Login = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-6xl">Inicia sesión y administra tus <br/>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <nav className='mt-10 lg:flex lg:justify-between'>
                    <Link to="/registrar" className='block text-center my-5 text-gray-500 transition-all duration-300 
